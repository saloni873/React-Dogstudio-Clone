...
const Dog = () => {
    ...
    useGSAP(()=>{
        ...
        document.querySelector(`.title[img-title="msichicago"]`).addEventListener("mouseenter", () => {
        ...
        document.querySelector(`.title[img-title="kikkfestival"]`).addEventListener("mouseenter", () => {
        ...
        document.querySelector(`.title[img-title="royalopera"]`).addEventListener("mouseenter", () => {
  ...
  return ( 
    <> 
    <primitive object={model.scene} position={[0.25 , -0.55 , 0]} rotation={[0, Math.PI/4.4, 0]}/>
