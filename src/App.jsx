  ...
  return ( 
    ...
    <main>
      <div className="images">
        ...
        <img id='navypier' src="/models/navypier.png" alt="" />
        <img id='msichicago' src="/models/msichicago.png" alt="" />
        <img id='kikkfestival' src="/models/kikkfestival.png" alt="" />
        <img id='royalopera' src="/models/royalopera.png" alt="" />
        <img id='louise' src="/models/louise.png" alt="" />
      </div>
      <Canvas 
         id='canvas-elem'
         style={{
    ...
    <section id='section-2'>
      <div className="titles">
        ...
        <div img-title="kikkfestival" className="title">
          <small>2020 - ONGOING</small>
          <h1>KIKK Festival 2018</h1>
        </div>
        <div img-title="royalopera" className="title">
          <small>2020 - ONGOING</small>
          <h1>Royal Opera Of Wallonia</h1>
        </div>
        <div img-title="louise" className="title">
          <small>2020 - ONGOING</small>
    ...
    <section id='section-3'>
      <div className="top">
        <div className="left">
          <h1>We're Crafting <br />Emotional <br />Experiences Aimed <br /> At Improving <br />Results</h1></div>
        <div className="right"></div>
      </div>
